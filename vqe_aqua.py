...
# Code partially adapted from qiskit-aqua example vqe files
...
imp_vf = 'from qiskit_aqua.utils.variational_forms.' \
...
# Make/open log file and print iformation from run
