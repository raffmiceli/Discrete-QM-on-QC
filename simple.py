...
class VarFormSIMPLE(VariationalForm):
    """Layers of Y rotations on all but the first qubit."""

    SIMPLE_CONFIGURATION = {
        'name': 'SIMPLE',
        'description': 'SIMPLE Variational Form',
        'input_schema': {
    ...
    def __init__(self, configuration=None):
        super().__init__(configuration or self.SIMPLE_CONFIGURATION.copy())
        self._num_qubits = 0
        self._depth = 0
    ...
    def init_args(self, num_qubits, depth, entangler_map=None,
        ...
        """
        self._num_parameters = (num_qubits-1) * depth
    ...
    def construct_circuit(self, parameters):
        ...
        for block in range(self._depth):
            for qubit in range(1,self._num_qubits):
